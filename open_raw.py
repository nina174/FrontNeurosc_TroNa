    ...
    for cond in condition:
        ...
        for filename in filenames:
            ...
            if "Nass" in sys:
                ...
                ## Set the montage
                digmon = mne.channels.read_dig_fif(".../montage_ANTWaveguard.fif")
               
                with open(".../positionfile.csv", "r") as fp:
            ...
            if glob(join(out_dir, f"{sys}", "final", f"{sub}*badch.txt")) != []:
            ...
            eeg_data.save(join(out_dir, f"{sys}", "final", f"{file[0]}raw.fif"), overwrite=False)
